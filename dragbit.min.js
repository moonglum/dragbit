...
1);a.css("z-index",d.fairlyHighZIndex)},moveCurrentElement:function(a,b){if(!c.data("lockInContainer")||d.checkBoundaries(b))c.data("moveX")&&(c.css("left",b.left),c.data("lastXPosition",a.clientX)),c.data("moveY")&&(c.css("top",b.top),c.data("lastYPosition",a.clientY))},checkBoundaries:function(a){var b=!0,d=c.data("container"),f=d.position().top,e=d.position().left,g=parseInt(d.css("width"),10),g=e+g,h=parseInt(d.css("height"),10),d=d.position().top+h,h=a.top;a=a.left;var k=parseInt(c.css("width"),
10),m=a+k,l=parseInt(c.css("height"),10),n=h+l;f>h&&(c.css("top",f+1),b=!1);e>a&&(c.css("left",e+1),b=!1);g<m&&(c.css("left",g-k-1),b=!1);d<n&&(c.css("top",d-l-1),b=!1);return b},calculateNewPosition:function(a){var b=parseInt(c.css("left"),10),d=parseInt(c.css("top"),10);return{left:b+(a.clientX-c.data("lastXPosition")),top:d+(a.clientY-c.data("lastYPosition"))}},cancelDocumentSelection:function(a){a.preventDefault&&a.preventDefault();a.stopPropagation&&a.stopPropagation();return a.returnValue=!1}};
f.fn.draggable=function(a){this.each(function(){var b=f(this),c=f.extend({handle:b,dragStart:function(){},dragging:function(){},dragStop:function(){},shadowMode:!1,moveX:!0,moveY:!0,lockInContainer:!1,originalPosition:b.position()},a);setTimeout(function(){d.setup(b,c)},100)});return this}})(jQuery);
